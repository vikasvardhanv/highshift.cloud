    ...
    const [messages, setMessages] = useState([
        {
            role: 'assistant',
            type: 'text',
            content: "I am your HighShift AI Creative Assistant. I can generate high-impact posts or create visuals. Just ask me to 'write a post about...' or 'generate an image of...'."
        }
    ]);
                ...
                <div className="flex items-center gap-4 mb-4 md:mb-0">
                    ...
                    <div>
                        <h2 className="text-lg font-bold text-white tracking-tight flex items-center gap-2">
                            HighShift AI <span className="px-1.5 py-0.5 rounded text-[10px] font-bold bg-indigo-500/20 text-indigo-300 border border-indigo-500/20 tracking-wide">PRO</span>
                        </h2>
                                ...
                                {msg.type === 'image' ? (
                                    <div className="rounded-xl overflow-hidden shadow-lg border border-white/10 mt-1">
                                        ...
                                        <div className="p-2 bg-slate-950/50 text-xs text-slate-400 flex justify-between">
                                            <span>Generated by HighShift AI</span>
            ...
            <div className="p-6 bg-slate-950 border-t border-white/5 z-20">
                ...
                <div className="text-center mt-3">
                    <p className="text-[10px] text-slate-600 uppercase tracking-widest font-medium">
                        Powered by HighShift AI Models
                    </p>
                </div>
            </div>
        </div>
